...
\item \texttt{docs/} --- methodology documents, including reviewer
checklists.
\item \texttt{scripts/build\_publication\_bundle.py} --- the bundle
builder.
\item \texttt{.zenodo.json} and \texttt{CITATION.cff} --- machine-readable
metadata.
